...
# Login for users with RUT, password, and token
@app.route('/cuenta_cap', methods=['POST'])
def cuenta_cap():
...
# Savings account
@app.route('/cuenta_ahorro', methods=['POST'])
def cuenta_ahorro():
    token = request.headers.get('Authorization')
    data = request.get_json()
    rut = data.get("rut")
...
# Movements for users with token and rut
@app.route('/movimientos_ahorro', methods=['POST'])
...
# Savings account
@app.route('/credito_cuotas', methods=['POST'])
def credito_cuotas():
    token = request.headers.get('Authorization')
    data = request.get_json()
    rut = data.get("rut")
...
# Movements for users with token and rut
@app.route('/movimientos_creditos', methods=['POST'])
def movimientos_credidos():
    token = request.headers.get('Authorization')
    data = request.get_json()
    rut = data.get("rut")
...
# Movements for users with token and rut
@app.route('/movimientos_lcc', methods=['POST'])
def movimientos_lcc():
    token = request.headers.get('Authorization')
    data = request.get_json()
    rut = data.get("rut")
